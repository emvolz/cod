...
# TODO  fix behaviour when no optimal weight found 
f = arw$fit
arw$summary
arw$optimalweight
```
...
```{r, fig.width=11, fig.height=11}
# Try to plot clusters, handle ggtree issues
tryCatch({
  plotclusters( f, chdf )
}, error = function(e) {
  cat("Cluster plot failed due to ggtree compatibility issue:\n")
  cat(e$message, "\n")
  cat("\nCluster summary:\n")
  ...
  names(cluster_stats) <- c("cluster", "stats")
  print(cluster_stats)
})
